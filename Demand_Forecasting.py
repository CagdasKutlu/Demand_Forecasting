...
# gain feature ın kazandırdığı kazanımdır. bölmeden önce ve bölmeden sonraki entropi değişimidir.
...
# earlystopping rounds ı getirmiyoruz. Çünkü işimiz bitti çünkü
lgb_params = {'metric': {'mae'},
              'num_leaves': 10,
              'learning_rate': 0.02,
              'feature_fraction': 0.8,
...
# Kaglle ın beklediği tahminleri üretmemiz lazım model predict diyerek x_testi soruyoruz
